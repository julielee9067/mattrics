...
// Parameters: SSID and PASSWD of the Access point to connect to. @STAIP is static IP you want to assign to connection
// More info here: https://controllerstech.com/send-and-receive-data-from-the-webserver-using-stm32/
